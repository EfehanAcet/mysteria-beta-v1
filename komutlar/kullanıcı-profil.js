...
exports.run = async (bot, msg, args) => {
        ...
        .setColor('#ffd100')
        .addField(`<:hype:813061092611326003> Katılım Tarihi (Discord)`, userinfo.dctarih, false)
        .addField(`<:hype:813061092611326003> Kimlik`, userinfo.id, true)
        .addField(`<:hype:813061092611326003> Botmu`, userinfo.bot, true)
        .addField(`<:hype:813061092611326003> Roller`, `${msg.guild.members.get(user.id).roles.filter(r => r.name !== "@everyone").map(r => r).join(' **|** ') || "**Bu kullanıcıda hiçbir rol bulunmuyor**"}`, false)
        .setFooter(`MysTeria Kullanıcı Bilgi Sistemi`)
